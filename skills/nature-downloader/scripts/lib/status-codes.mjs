...
// Slider/drag CAPTCHA signals — always return a user-handoff status.
...
export function classifyWall(url, title, bodyHint = "") {
  ...
  // 3. Slider / drag CAPTCHA — classify as publisher verification for handoff.
  if (SLIDER_CAPTCHA_RE.test(s)) {
    return { status: STATUS.PUBLISHER_VERIFICATION_WAITING_USER, reason: "slider CAPTCHA requires user verification" };
  }
