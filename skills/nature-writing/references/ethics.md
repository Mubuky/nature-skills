<!-- MODIFIED IN THIS DERIVATIVE: AI drafting boundaries were aligned with author-provided evidence workflows; see ../../../NOTICE (Apache-2.0 section 4(b)). -->
...
- ask AI to originate the paper's scientific argument, claims, or evidence
  without an author-provided factual and evidentiary basis
