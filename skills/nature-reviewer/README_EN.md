...
- Generate the requested number of differently focused reviewer reports
  (default three) and one cross-review synthesis.
...
- Normalize shared concerns to stable issue keys and use the synthesis to
  distinguish supported consensus from single-reviewer emphasis.
...
- The requested number of peer-review style reports (default three).
