...
- Reviewer reports may differ only in `emphasis`, whether their count was
  requested by the user or defaults to three.
...
- For the default three-reviewer configuration, prefer:
