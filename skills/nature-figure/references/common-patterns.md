<!-- MODIFIED IN THIS DERIVATIVE: plotting-pattern guidance was adapted for this distribution; see ../../../NOTICE (Apache-2.0 section 4(b)). -->
...
- [demos.md](demos.md) — Bundled chart-atlas and gallery examples with provenance
