<!-- MODIFIED IN THIS DERIVATIVE: tutorial content and bundled-asset routing were adapted for this distribution; see ../../../NOTICE (Apache-2.0 section 4(b)). -->
...
For bundled chart-atlas and gallery previews, including provenance, open
[demos.md](demos.md).
