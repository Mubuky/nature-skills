...
if __name__ == '__main__':
    ...
    ax.bar(range(len(data_comparison_IEDB['mean'])),
           ...
           yerr=data_comparison_IEDB['uncertainty'][:, 0],
           capsize=5,
    ...
    ax.bar(range(len(data_comparison_IEDB['mean'])),
           ...
           yerr=data_comparison_IEDB['uncertainty'][:, 1],
           capsize=5,
           color=data_comparison_IEDB['colors'])
    ax.set_xticks([])
    ...
    ax.bar(range(len(data_comparison_IEDB['mean'])),
           ...
           yerr=data_comparison_IEDB['uncertainty'][:, 2],
           capsize=5,
           color=data_comparison_IEDB['colors'])
    ax.set_xticks([])
    ...
    ax.barh(range(len(data_ablation_IEDB['mean'][:, 0])),
            ...
            xerr=data_ablation_IEDB['uncertainty'][:, 0],
    ...
    ax.barh(range(len(data_ablation_IEDB['mean'][:, 1])),
            ...
            xerr=data_ablation_IEDB['uncertainty'][:, 1],
            color=[(0.215686, 0.458824, 0.729412, alpha) for alpha in np.linspace(0.2, 1.0, 12)],
            ecolor='k',
            capsize=5,
    )
    ...
    ax.barh(range(len(data_ablation_IEDB['mean'][:, 2])),
            ...
            xerr=data_ablation_IEDB['uncertainty'][:, 2],
            color=[(0.215686, 0.458824, 0.729412, alpha) for alpha in np.linspace(0.2, 1.0, 12)],
            ecolor='k',
            capsize=5,
    )
    ...
    ax.bar(range(len(data_comparison_Cancer['mean'])),
           ...
           yerr=data_comparison_Cancer['uncertainty'][:, 0],
           capsize=5,
    ...
    ax.bar(range(len(data_comparison_Cancer['mean'])),
           ...
           yerr=data_comparison_Cancer['uncertainty'][:, 1],
           capsize=5,
           color=data_comparison_Cancer['colors'])
    ax.set_xticks([])
    ...
    ax.bar(range(len(data_comparison_Cancer['mean'])),
           ...
           yerr=data_comparison_Cancer['uncertainty'][:, 2],
           capsize=5,
           color=data_comparison_Cancer['colors'])
    ax.set_xticks([])
    ...
    ax.bar(range(len(items_shown)),
           ...
           yerr=data_ablation_Cancer['uncertainty'][:, 0][items_shown],
           capsize=5,
    ...
    ax.bar(range(len(items_shown)),
           ...
           yerr=data_ablation_Cancer['uncertainty'][:, 1][items_shown],
           capsize=5,
           color=[(0.215686, 0.458824, 0.729412, alpha) for alpha in [1.0, 0.7, 0.4]])
    ax.set_xticks([])
    ...
    ax.bar(range(len(items_shown)),
           ...
           yerr=data_ablation_Cancer['uncertainty'][:, 2][items_shown],
           capsize=5,
           color=[(0.215686, 0.458824, 0.729412, alpha) for alpha in [1.0, 0.7, 0.4]])
    ax.set_xticks([])
