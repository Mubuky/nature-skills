...
# Preserve the upstream error-bar magnitudes exactly. The available source does
# not establish whether they represent SD, SEM, or another estimate: only the
# Mean PPVn column is divided by sqrt(5). Use a neutral name and do not
# reinterpret or rescale these values without the underlying experiment data.
