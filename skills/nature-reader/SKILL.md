...
name: nature-reader
description: >-
  Produce a source-grounded full-paper Markdown reader with Chinese-English
...
Build the Terminology Ledger from `references/terminology-ledger.md` as you
translate; it becomes the `paper.md` recurring-term table and the
`source_map.json` glossary.
