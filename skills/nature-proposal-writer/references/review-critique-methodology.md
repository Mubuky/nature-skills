...
Load alongside the base `nature-proposal-writer` SKILL.md. This reference
provides the evaluation framework; the base skill provides the scoped research
context and project contract.
