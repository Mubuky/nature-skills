...
Support grade: [grade]
Evidence basis: [abstract/publisher page/full text]
Checked URL and time: [URL; ISO-8601 timestamp]
Evidence locator: [section/page/figure/table/paragraph]
Evidence excerpt or precise paraphrase: [bounded excerpt or paraphrase]
Support reasoning: [why the result supports or does not support the exact claim]
Contradiction status: [none_found/found/unresolved]
Retraction status: [none_found/found/unresolved]
Citation wording: [how the manuscript claim should be narrowed or phrased if used]
```

Keep bibliographic identity and semantic support separate. Publisher/version-of-
record pages and registries establish identity; primary full text, an abstract,
or a publisher summary can establish semantic support at different strengths.
Titles and metadata never establish semantic support.
