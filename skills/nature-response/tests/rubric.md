...
- Target-journal formatting is followed. Reviewer page breaks are present only
  when required by the journal, user, or print/PDF output contract; ordinary
  Markdown does not require them.
...
- Reviewer section formatting violates an explicit target-journal, user, or
  print/PDF output requirement.
