...
def markdown_report(result: dict) -> str:
    ...
    lines.extend(
        [
            ...
            "## Scope",
            "",
            "This XML audit checks structural risk signals and therefore reports `structural_qa_only`. It does not verify scientific correctness or replace rendered-slide visual inspection, and it must not be cited as a rendered visual QA pass.",
        ]
    )
    return "\n".join(lines) + "\n"
